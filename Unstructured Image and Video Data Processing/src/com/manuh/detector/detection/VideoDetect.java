...
public class VideoDetect extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(VideoDetect.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new VideoDetect(), args);
		t = cvGetTickCount() - t;
