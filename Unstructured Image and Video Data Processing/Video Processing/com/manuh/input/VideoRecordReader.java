...
public class VideoRecordReader extends RecordReader<Text, VideoObject>{
	...
	private VideoObject vsplits[] = null;
	...
	public void initialize(InputSplit genericSplit, TaskAttemptContext context)
	    ...
	    start = 0;
	    //end = 2; // Make it dynamic
	    end =  job.getInt("mapreduce.videosplit.number",1);
		...
		fileIn.readFully(b);
		VideoDevider vd = new VideoDevider(b,filename,end);
		vsplits=vd.seperateVideo();
	}
